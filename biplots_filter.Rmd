...
pdf("figs/fig2_refseq_biplot.pdf", height=6, width=10)
par(mfrow=c(1,2))
...
text(.01,.009,labels="Gv", cex=0.8,col="indianred1")
...
text(.014,.0015,labels="Pr", cex=0.8,col=rgb(.67,.51,1))
...
text(-.004,-.010,labels="Me", cex=0.8,col=rgb(.6,.8,.2))
text(.01,-.014,labels="AS", cex=0.8,col="black")
...
pdf("figs/fig3_subsys4_KO__biplot.pdf", height=6, width=10)
...
colours <- c("indianred1", "steelblue3",  "skyblue1", "mediumorchid", "olivedrab3", "royalblue4",
...
biplot(k.min.pcx, cex=cex, col=col, var.axes=F,
    ...
    scale=1, ylabs=points.k, main="KEGG"
)
# scale=0
text(-.09,-.09,labels="H1", cex=1.5)
text(-.09,.08,labels="H2", cex=1.5)
text(.075,.08,labels="BV2", cex=1.5)
text(.075,-.09,labels="BV1", cex=1.5)
...
colours <- c("indianred1", "royalblue4", "skyblue1", "mediumorchid", "olivedrab3", "steelblue3",
   "pink", "#FFED6F", "mediumorchid3", "ivory2", "tan1", "aquamarine3", "#C0C0C0",
    "mediumvioletred", "#999933", "#666699", "#CC9933", "#006666", "#3399FF",
   "#993300", "#CCCC99", "#666666", "#FFCC66", "#6699CC", "#663366", "#9999CC", "#CCCCCC",
   "#669999", "#CCCC66", "#CC6600", "#9999FF", "#0066CC", "#99CCCC", "#999999", "#FFCC00",
