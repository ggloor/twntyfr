...
points(d.pcx$rotation[,1][lc], d.pcx$rotation[,2][lc], pch=19, cex=0.1, col="cyan")
points(d.pcx$rotation[,1][li], d.pcx$rotation[,2][li], pch=19, cex=0.1, col="steelblue3")
points(d.pcx$rotation[,1][lj], d.pcx$rotation[,2][lj], pch=19, cex=0.1, col="royalblue4")
points(d.pcx$rotation[,1][lje], d.pcx$rotation[,2][lje], pch=19, cex=0.1, col="paleturquoise1")
points(d.pcx$rotation[,1][bvab], d.pcx$rotation[,2][bvab], pch=19, cex=0.1, col="yellow")
points(d.pcx$rotation[,1][pb], d.pcx$rotation[,2][pb], pch=19, cex=0.1, col="mediumpurple1")
points(d.pcx$rotation[,1][gv], d.pcx$rotation[,2][gv], pch=19, cex=0.1, col="indianred1")
points(d.pcx$rotation[,1][me], d.pcx$rotation[,2][me], pch=19, cex=0.1, col="olivedrab3")
points(d.pcx$rotation[,1][sn], d.pcx$rotation[,2][sn], pch=19, cex=0.1, col="pink")
points(d.pcx$rotation[,1][di], d.pcx$rotation[,2][di], pch=19, cex=0.1, col="magenta")
points(d.pcx$rotation[,1][le], d.pcx$rotation[,2][le], pch=19, cex=0.1, col="brown")
points(d.pcx$rotation[,1][as], d.pcx$rotation[,2][as], pch=19, cex=0.1, col="black")
...
KO.g.df <- data.frame(Systematic.name=V(g)$name, cluster=g.clust$membership,
    cluster.size=g.clust$csize[g.clust$membership])
write.table(KO.g.df, file="KO.g.df.txt", sep="\t", quote=F, col.names=NA)
