...
pdf("figs/f2_refseq_seed.pdf", height=6.5, width=12)
par(mfrow=c(1,2))
...
e.f <- d[which(apply(e,1,mean)> 56),]

points.e <- c(rep("o", nrow(e)))
...
pdf("figs/fig2_refseq_biplot.pdf", height=6, width=6)
par(mfrow=c(1,1))
...
biplot(e.min.pcx,choices=c(2,3), cex=cex, col=col, var.axes=F,
